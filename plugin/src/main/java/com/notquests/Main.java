...
public final class Main extends JavaPlugin {
    ...
    private com.notquests.paper.NotQuests notQuests;
    ...
    public com.notquests.paper.NotQuests getNotQuests(){
        return notQuests;
    }
    ...
    public void onEnable() {
        ...
        if(PaperLib.isPaper()){
            ...
            notQuests = new com.notquests.paper.NotQuests(instance);
            notQuests.onLoad();
        }else{
        ...
        Bukkit.getScheduler().scheduleSyncDelayedTask(this, new Runnable() {
            ...
            public void run() {
                if(PaperLib.isPaper()){
                    ...
                    notQuestsSpigot = new com.notquests.spigot.NotQuests(instance);
