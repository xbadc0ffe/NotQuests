...
final class ConditionTypeField<V> {
    private final String name;
    private final FieldType<V> type;
    private final NQDescription description;
    private final boolean flag;

    ConditionTypeField(final String name, final FieldType<V> type, final String description, final boolean flag) {
        this.name = FieldType.requireText(name, "condition field name");
        this.type = Objects.requireNonNull(type, "type");
        this.description = requireDescription(description, (flag ? "condition flag " : "condition field ") + name);
        this.flag = flag;
    }
