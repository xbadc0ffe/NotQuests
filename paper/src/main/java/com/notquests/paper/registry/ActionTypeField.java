...
final class ActionTypeField<V> {
    private final String name;
    private final FieldType<V> type;
    private final NQDescription description;
    private final boolean flag;

    ActionTypeField(final String name, final FieldType<V> type, final String description, final boolean flag) {
        this.name = FieldType.requireText(name, "action field name");
        this.type = Objects.requireNonNull(type, "type");
        this.description = requireDescription(description, (flag ? "action flag " : "action field ") + name);
        this.flag = flag;
    }
