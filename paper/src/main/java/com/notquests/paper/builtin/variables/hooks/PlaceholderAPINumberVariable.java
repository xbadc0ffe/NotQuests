...
public class PlaceholderAPINumberVariable extends Variable<Double> {
    public PlaceholderAPINumberVariable(NotQuests main) {
        ...
        addRequiredBooleanFlag(com.notquests.paper.commands.framework.NQFlag.presence("removeTextFromPlaceholderValue", com.notquests.paper.commands.framework.NQDescription.of("Tries to remove all text from the placeholder before parsing")));
    }
