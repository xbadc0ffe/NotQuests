...
import com.notquests.paper.commands.*;
import com.notquests.paper.commands.category.item.AdminItemsCommand;
import com.notquests.paper.commands.category.tag.AdminTagCommands;
...
import com.notquests.paper.commands.framework.NQCommands;
import com.notquests.paper.commands.framework.NQDescription;
import com.notquests.paper.commands.framework.NQFlag;
import static com.notquests.paper.commands.arguments.ActionArgument.actionArgument;
...
public class CommandManager {
    ...
    public final ObjectiveHolder getObjectiveHolderFromContextAndLevel(final NQCommandContext context, final int level) {
        return com.notquests.paper.commands.arguments.ObjectiveArgument.resolveHolder(context.brigadier(), level);
    }

    public final Objective getObjectiveFromContextAndLevel(final NQCommandContext context, final int level) {
        final ObjectiveHolder holder = com.notquests.paper.commands.arguments.ObjectiveArgument.resolveHolder(context.brigadier(), level + 1);
