...
import com.notquests.paper.gui.icon.ButtonType;
import com.notquests.paper.gui.icon.SpecialIconType;
...
public class CustomGui {
    ...
    private Gui handlePagedItemsGui(GuiContext guiContext) {
        ...
        var guiSize = (int) String.join("", structure).chars().filter(c -> c == 'X').count();
