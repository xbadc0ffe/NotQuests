...
import static com.notquests.paper.commands.arguments.SpeakerArgument.speakerArgument;
    ...
    public AdminConversationCommands(final NotQuests main,
        ...
        manager.command(conversationEditBuilder
                ...
                .handler((context) -> {
                    ...
                    final Speaker speaker = com.notquests.paper.commands.arguments.SpeakerArgument.resolveSpeaker(foundConversation, context.get("speaker"));
