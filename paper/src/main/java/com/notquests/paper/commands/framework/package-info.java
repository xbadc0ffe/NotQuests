 ...
 *
 * <ul>
 *   <li>{@link com.notquests.paper.commands.framework.NQArgumentType} — base for custom
 *       argument types (replaces Cloud's {@code ArgumentParser}/{@code ParserDescriptor}).</li>
 *   <li>{@link com.notquests.paper.commands.framework.NQCommands} — registrar that hooks
