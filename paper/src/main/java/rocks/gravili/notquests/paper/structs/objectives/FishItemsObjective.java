...
public class FishItemsObjective extends Objective {
    ...
    public static void handleCommands(
        ...
        manager.command(addObjectiveBuilder
                .required("materials", itemStackSelectionArgument(main), NQDescription.of("Material of the item which needs to be fished"))
                .required("amount", numberVariableArgument("amount", null), NQDescription.of("Amount of items which need to be fished"))
                .handler(
                        (context) -> {
