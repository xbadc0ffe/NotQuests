...
@Getter
public class NumberVariableValueParser<C> {
    ...
    public static <C> @NonNull NumberVariableValueParser<C> of(String identifier, Variable<?> variable, NQSuggestionProvider suggestionProvider) {
