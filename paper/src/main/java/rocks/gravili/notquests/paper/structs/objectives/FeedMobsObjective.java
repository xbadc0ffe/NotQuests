...
public class FeedMobsObjective extends Objective {
  ...
  public static void handleCommands(
    ...
    manager.command(addObjectiveBuilder
            .required("entityType", entityTypeParser(main, false), Description.of("Type of Entity the player has to feed."))
            .required("amount", numberVariableParser("amount", null), Description.of("Amount of times the player needs to feed this entity."))
            .handler(
                (context) -> {
