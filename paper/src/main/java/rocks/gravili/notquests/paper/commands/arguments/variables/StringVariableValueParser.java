...
@Getter
public class StringVariableValueParser<C> {
    ...
    public static <C> @NonNull StringVariableValueParser<C> of(String identifier, Variable<?> variable, NQSuggestionProvider suggestionProvider) {
