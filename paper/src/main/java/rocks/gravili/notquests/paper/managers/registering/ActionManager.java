    ...
    public void addAction(final Action action, final NQCommandContext context, final ActionFor actionFor) {
        ...
        if (quest != null) {
            ...
            if (objectiveOfQuest != null) { // Objective Reward
                ...
                context.sender().sendMessage(main.parse("<success>" + getActionType(action.getClass())
            ...
            if (actionFor == ActionFor.INLINE) {
                ...
                if (main.getActionsYMLManager().getAction(actionIdentifier) == null) {
                    context.sender().sendMessage(main.parse(main.getActionsYMLManager().addAction(actionIdentifier, action)));
                } else {
