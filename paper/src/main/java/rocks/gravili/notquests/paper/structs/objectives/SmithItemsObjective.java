...
public class SmithItemsObjective extends Objective {
    private ItemStackSelection itemStackSelection;

    public SmithItemsObjective(final NotQuests main) {
        super(main);
    }
    ...
    public static void handleCommands(
        ...
        manager.command(addObjectiveBuilder
                .required("materials", itemStackSelectionArgument(main), NQDescription.of("Smithing result item that should count. Use 'any' if every smithing result should count."))
                .required("amount", numberVariableArgument("amount", null), NQDescription.of("Amount of smithing result items the player needs to take."))
                .handler(context -> {
                    final SmithItemsObjective objective = new SmithItemsObjective(main);
    ...
    public boolean countsSmithingResult(final ItemStack itemStack) {
    ...
    public String getTaskDescriptionInternal(
        ...
        return main.getLanguageManager()
                .getString(
                        ...
                        activeObjective,
                        Map.of(
                                "%ITEMTOSMITHTYPE%", getItemStackSelection().getAllMaterialsListedTranslated("main"),
                                "%ITEMTOSMITHNAME%", "",
                                "%(%", "",
                                "%)%", ""));
    }
